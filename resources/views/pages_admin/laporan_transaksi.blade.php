...
/* =========================================================
   SIHIR RESPONSIVE KHUSUS MOBILE (MEMPERBAIKI LAYOUT PATAH)
   ========================================================= */
@media (max-width: 768px) {
    /* 1. Kurangi padding luar agar tidak makan tempat */
    .wrap { padding: 15px 10px; }
    
    /* 2. Kecilkan ukuran judul biar nggak patah 2 baris */
    .page-title { font-size: 16px; margin-bottom: 15px; border-left-width: 3px; padding-left: 10px; }
    
    /* 3. Bariskan filter ke bawah (Stacking) */
    .filter-form { flex-direction: column; gap: 10px; align-items: stretch; }
    
    /* 4. Paksa semua kotak pencarian & dropdown jadi full width (100%) */
    .search-box { width: 100% !important; max-width: 100% !important; }
    
    /* 5. Paksa tombol PDF jadi full width dan teksnya di tengah */
    .btn-pdf { width: 100%; margin-left: 0; justify-content: center; }

    /* 6. Atur ulang jarak area tabel */
    .card { margin-top: 15px; border-radius: 8px; }
